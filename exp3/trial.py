...
from model import MlPipelineClassifier
from load_data import telescope_dataset
...
if __name__ == "__main__":
    ...
    hparams = {
        "op_1": {"_name": "SelectPercentile", "percentile": 2},
        "op_2": {"_name": "none"},
        "op_3": {"_name": "Normalizer", "norm": "l1"},
        "op_4": {"_name": "PCA", "svd_solver": "randomized", "iterated_power": 3},
        "op_5": {
